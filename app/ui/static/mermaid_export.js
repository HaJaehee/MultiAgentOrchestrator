/**
 * Mermaid Diagram Export & Clipboard Utility
...
(function() {
    window.MadoMermaid = {
        /**
         * SVG 엘리먼트를 Canvas 렌더링에 안전한 순수 SVG 로 정제합니다.
         * foreignObject 및 외부 @import 등을 변환/제거하여 Canvas Tainting 을 원천 차단합니다.
         */
