...
| 위치 | 언어 | 성격 | 배포 패키지 |
| :--- | :--- | :--- | :--- |
| `docs/user_manual/` | 한국어 | **이 문서 모음** | 포함 |
| [README.md](../../../README.md) | 한국어 | 저장소 최상위 안내. 설치, 기능 요약, 설정 가이드 | 포함 |
| `wiki/` | 영어 | 기술 위키. 설계 배경과 세부 구현 | 개발 저장소만 |
| `CLAUDE.md` | 한국어 | 프로젝트 명세서 (요구사항 원문) | 개발 저장소만 |
